                    ...
                    <ul className="space-y-4 text-white">
                      <li className="flex gap-4">
                        ...
                        <p className="font-body-md text-body-md">
                          ...
                          <span className="underline decoration-secondary-fixed-dim">Fante Kenkey</span> at the nearby roadside stalls for a
                          true Central Region taste.
                        </p>
                      </li>
                      <li className="flex gap-4">
                  ...
                  <div className="p-6 rounded-2xl bg-surface border border-outline-variant/30 shadow-sm flex flex-col gap-4">
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3 items-center">
                        ...
                        <div>
                          <p className="font-label-lg text-label-lg text-on-surface">Adwoa Mansah</p>
                  ...
                  <div className="p-6 rounded-2xl bg-surface border border-outline-variant/30 shadow-sm flex flex-col gap-4">
                    <div className="flex justify-between items-start">
                      <div className="flex gap-3 items-center">
                        ...
                        <div>
                          <p className="font-label-lg text-label-lg text-on-surface">John Smith</p>
      ...
      <div className="block md:hidden">
        ...
        <section className="relative h-[574px] w-full overflow-hidden">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAMHA1rMp-33YtPzo31q8fiKKQxDbtLGVSJMf2xgPiNQMutbgjDvc7jBE7DbH6hVRPw3um8CxQ1cnVCu7Zer0EGC5SvxWM2ovQDZXfgsDoVdLjFbGsqClFyEUhol7Vd838DA8Iw_-BKRBAORrtFgLJBq1pcN3fxI6Qo1gyXftSHR4uYnKFB6OjL0jM8jXhGd9gUEhxUXcKsVfGJlSdMs8sUsntxQq1Fxb3w_vWL_-OmYU62Cd5QM0XQbOXIrtnPMZxjkIq1x14Qe2ge')",
            }}
          />
          ...
          <div className="absolute bottom-6 left-0 right-0 px-container-padding-mobile">
            ...
            <h1 className="font-display-lg-mobile text-on-surface leading-tight text-3xl font-bold">Kakum National Park</h1>
        ...
        <main className="px-container-padding-mobile pb-32 -mt-4 relative z-10">
          ...
          <div className="space-y-4 mb-10">
            ...
            <details className="group bg-white rounded-2xl border border-outline-variant/30 overflow-hidden" open>
              ...
              <div className="px-5 pb-5 text-on-surface-variant leading-relaxed text-sm">
                Kakum National Park is a pristine rainforest reserve located in the Central Region of Ghana. It is most famous for its world-renowned Canopy Walkway, which consists of seven bridges hanging 40 meters above the forest floor. Beyond the walkway, visitors can enjoy guided nature walks to discover rare flora and fauna, including forest elephants and over 300 bird species.
              </div>
            </details>
            ...
            <details className="group bg-white rounded-2xl border border-outline-variant/30 overflow-hidden">
              ...
              <div className="px-5 pb-5">
                <div className="flex gap-4 p-3 bg-surface-container-low rounded-xl mb-3">
                  ...
                  <div>
                    <p className="font-bold text-on-surface text-sm">Fufu &amp; Light Soup</p>
                    <p className="text-xs text-on-surface-variant">Found at the park&apos;s local chop bars. A must-try Central Region specialty.</p>
                  </div>
                </div>
              </div>
            </details>
            ...
            <div className="flex gap-4 overflow-x-auto hide-scrollbar pb-4 -mx-container-padding-mobile px-container-padding-mobile">
              <div className="min-w-[280px] bg-white p-5 rounded-2xl border border-outline-variant/30 shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-full bg-primary-fixed flex items-center justify-center font-bold text-primary">KO</div>
                  <div>
          ...
          <section className="mb-10">
            ...
            <div className="flex gap-4 overflow-x-auto hide-scrollbar pb-4 -mx-container-padding-mobile px-container-padding-mobile">
              <Link href="/attractions/elmina-castle" className="min-w-[180px] group cursor-pointer block shrink-0">
                ...
                <p className="font-bold text-on-surface text-sm">Elmina Castle</p>
                <p className="text-xs text-on-surface-variant">45 mins away</p>
              </Link>
              
              <Link href="/attractions/cape-coast-castle" className="min-w-[180px] group cursor-pointer block shrink-0">
                <div className="h-32 rounded-2xl bg-gray-200 overflow-hidden mb-2">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform"
                ...
                <p className="font-bold text-on-surface text-sm">Cape Coast Castle</p>
                <p className="text-xs text-on-surface-variant">50 mins away</p>
              </Link>
              
              <Link href="/attractions/anomabo-beach" className="min-w-[180px] group cursor-pointer block shrink-0">
                <div className="h-32 rounded-2xl bg-gray-200 overflow-hidden mb-2">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform"
                ...
                <p className="font-bold text-on-surface text-sm">Anomabo Beach</p>
