...
export default function RegisterPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <main className="min-h-screen flex flex-col md:flex-row bg-background text-on-surface font-body overflow-x-hidden">
      {/* DESKTOP LEFT SIDE */}
      <section className="relative hidden md:flex md:w-1/2 lg:w-3/5 min-h-screen h-full overflow-hidden">
        <div
        ...
        />
        <div className="relative z-10 flex flex-col justify-between h-full p-container-padding-desktop bg-gradient-to-t from-black/75 via-black/30 to-transparent w-full">
          <div>
          ...
          <div className="max-w-xl my-auto">
            <h2 className="font-display-lg text-display-lg text-white mb-6 leading-tight drop-shadow-md">
          ...
          <div className="flex items-center gap-4 text-white/80 font-label-lg pt-4 border-t border-white/20">
